    ...
    <div className="flex flex-col bg-light-blue-50 h-auto md:h-auto">
            ...
            <div className="flex">
                ...
                <div className="flex items-center flex-col">
                    ...
                    <p className="mt-8 text-black text-6xl font-serif text-center">About CarsForum</p>

                    <p className="mt-12 text-black text-3xl font-serif text-center">World-class Cars | Our Mission</p>
                    <p className="mt-12 text-black text-xl font-serif text-center">At CarsForum, our mission is to provide a seamless and trustworthy <br/> platform for buying and selling second-hand cars. <br/> We strive to make the car buying experience convenient, transparent, and enjoyable for every customer.</p>
                    ...
                    <p className="mt-12 text-black text-xl font-serif text-center">CarsForum is a team of passionate car enthusiasts dedicated to revolutionizing the way people buy and sell used cars. With years of experience in the automotive industry, our team brings expertise, integrity, and innovation to every aspect of our business.</p>
